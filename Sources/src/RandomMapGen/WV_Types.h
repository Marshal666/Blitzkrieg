...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//“емплейт дл€ создани€ векторов обьектов с весами,
//веса могут быть любыми неотрицательными целыми числами
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
template <class TYPE>
class CWeightVector
{
	std::vector<TYPE> elements; //элементы (должны уметь упаковыватьс€ в контейнеры)
	std::vector<int> weights;		//веса ( разница между сосед€ми - вес текущего элемента )
