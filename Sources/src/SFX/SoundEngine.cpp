...
bool CSoundEngine::SearchDevices()
{
	...
	for ( int i = 0; i < nNumDrivers; ++i )
	{
		...
		dr.supportA3DOcclusions = nCaps & 0;
		dr.supportA3DReflections = nCaps & 0;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
signed char __stdcall NextMelodyCallback( FSOUND_STREAM *stream, void *buff, int len, void *param )
{
...
void CSoundEngine::PlayStream( const char *pszFileName, bool bLooped, const unsigned int nTimeToFadePrevious )
{
	...
	else
	{
		...
		if ( pStreamingSound )
		{
			...
			FSOUND_Stream_SetEndCallback( pStreamingSound, NextMelodyCallback, (void*)(this) );
			if ( bStreamingPaused ) 
