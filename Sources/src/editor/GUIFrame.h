...
// Operations
public:
	virtual void Init( IGFX *_pGFX );			//ининциализаци€
	virtual void ShowFrameWindows( int nCommand );
	virtual void GFXDraw();

	BOOL Run();										//¬ызываетс€ из EditorApp OnIdle()
...
private:
	...
	bool bRunning;								//есть два состо€ни€, редактирование и предварительный просмотр
	...
	enum EMode m_mode;						//текущий мод, определ€ет активное действие мышки, например перетаскивание объекта или рисование нового
	...
	EResizeMode m_resizeMode;			//дл€ определени€ направлени€ resize
...
protected:
	virtual BOOL SpecificTranslateMessage( MSG *pMsg );			//специфична€ обработка сообщений дл€ модул€
	virtual void SpecificInit();														//дл€ инициализации внутренних данных после загрузки проекта или создании нового
	virtual void SpecificClearBeforeBatchMode();
	virtual void SpecificSave( IDataTree *pDT );						//вызываетс€ при записи проекта, нужно только в GUI composer
